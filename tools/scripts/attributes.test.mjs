...
export const testCatalogAttributes = async (superAdminToken) => {
  ...
  log(
    ...
    createGroupRes.data?.createAttributeGroup || createGroupRes.errors,
  );
  ...
  if (groupId) {
    ...
    log(
      '➕',
      'Create Attribute Values (S, M)',
      !createValueS.errors && !createValueM.errors,
      [createValueS.data, createValueM.data],
    );
    ...
    log(
      ...
      'Get Group with Values',
      !getGroupRes.errors,
      getGroupRes.data?.attributeGroup || getGroupRes.errors,
    );
    ...
    log(
      ...
      !listRes.errors,
      listRes.data?.attributeGroups || listRes.errors,
    );
    ...
    log(
      ...
      deleteGroupRes.data?.deleteAttributeGroup || deleteGroupRes.errors,
    );
  }
};
