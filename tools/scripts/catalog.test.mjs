...
export const testCatalogModule = async (superAdminToken) => {
  ...
  log(
    ...
    !createParentRes.errors,
    createParentRes.data?.createCategory || createParentRes.errors,
  );
  ...
  if (parentId) {
    ...
    log(
      ...
      !createChildRes.errors,
      createChildRes.data?.createCategory || createChildRes.errors,
    );
    ...
    log(
      ...
      'Category Tree',
      !treeRes.errors,
      treeRes.data?.categoryTree || treeRes.errors,
    );
    ...
    if (childId) {
      ...
      log(
        ...
        !pathRes.errors,
        pathRes.data?.categoryPath || pathRes.errors,
      );
    }
    ...
    log(
      ...
      'List Categories',
      !listRes.errors,
      listRes.data?.categories || listRes.errors,
    );
    ...
    if (childId) {
      ...
      log(
        ...
        'Update Category',
        !updateRes.errors,
        updateRes.data?.updateCategory || updateRes.errors,
      );
      ...
      log(
        ...
        !deleteChildRes.errors,
        deleteChildRes.data?.deleteCategory || deleteChildRes.errors,
      );
    }
    ...
    log(
      ...
      !deleteParentRes.errors,
      deleteParentRes.data?.deleteCategory || deleteParentRes.errors,
    );
  }
};
